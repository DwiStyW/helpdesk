...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container">
            <!-- HEADER DESKTOP-->
            <?php $this->loa->view('admin/notif.php') ?>
            <!-- HEADER DESKTOP-->
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h4>No Ticket : <?php $tiket->notiket ?></h4>
                                <h4 style="text-align:right;">Status :
                                    <?php if ($tiket->status == 'new') { ?>
                                        <span style="color:red"> New</span>
                                    <?php } else if ($tiket->status == 'proses') { ?>
                                        ...
                                        <div class="card">
                                            <form action="insert.php?mode=2" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col col-md-3">
                                                            <label class="form-control-label">Kepala</label>
                                                        </div>
                                                        <div class="col-12 col-md-9">
                                                            <select name="untuk[]" type="select" class="form-control" required="required">
                                                                <?php
