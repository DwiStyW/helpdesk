            ...
            <div class="header-wrap">
                ...
                <div class="account-wrap" style="padding: 10px">
                    <div class="account-item clearfix js-item-menu">
                        <div class="image">
                            <img src="<?= base_url() ?>assets/images/avatar-01.jpg" alt="John Doe" />
                        </div>
                        <div class="content">
                            <a class="js-acc-btn" href="#"><?php //echo $user_login['username']; 
                                                            ?></a>
                        </div>
                        <div class="account-dropdown js-dropdown">
                            <div class="info clearfix">
                                ...
                                <div class="content">
                                    <h5 class="name">
                                        <a href="#"><?php //echo $user_login['username']; 
                                                    ?></a>
                                    </h5>
                                    <span class="email"><?php //echo $user_login['fullname']; 
                                                        ?></span>
                                </div>
                            </div>
